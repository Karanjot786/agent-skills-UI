        ...
        <section className="relative overflow-hidden min-h-[90vh] flex flex-col">
          ...
          <div className="container mx-auto px-6 py-6 relative z-10 flex-1 flex flex-col">
            ...
            >
              ...
              {/* Get started button - Pill style with animated arrow */}
              <div className="flex items-center justify-center">
                <Link href="/marketplace">
                  <div className="group cursor-pointer border border-white/10 bg-zinc-900/80 gap-2 h-[60px] flex items-center p-[10px] rounded-full hover:border-cyan-500/30 transition-all duration-300">
                ...
                {/* <a
                  href="/docs"
                  className="ml-4 text-sm font-medium text-zinc-400 hover:text-cyan-400 transition-colors flex items-center gap-1"
                >
                  Read Docs
